...
<footer class="site-footer" role="contentinfo">
  <div class="container">
    <div class="footer-top">
      <div>
        ...
        <p class="footer-tagline">Former mieux. Performer durablement.<br><span style="color:#fff;">Spécialiste formation CHR.</span></p>
  ...
  function initMobileFloatingCTA() {
    ...
    bar.innerHTML = '<a href="tel:+33689417517" class="btn btn-secondary">📞 Appeler</a>' +
      '<a href="/contact/index.html" class="btn btn-primary">Déposer ma candidature</a>';
